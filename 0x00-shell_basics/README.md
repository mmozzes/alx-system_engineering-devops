Created shell basics Scripts directory
...
6-firstdirectory: creates a my first directory directory in /tmp/
...
school.mgc: magic file holberton.mgc that can be used with the command file to detect School data files
